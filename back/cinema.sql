...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2025 a las 09:03:49
...
--
-- Estructura de tabla para la tabla `film_sessions`
--
...
(4, '2025_03_04_090444_create_personal_access_tokens_table', 1),
(5, '2025_03_04_103657_create_movies_table', 1),
(6, '2025_03_04_104943_create_film_sessions_table', 1),
(7, '2025_03_04_104944_create_seats_table', 1),
(8, '2025_03_04_104959_create_tickets_table', 1);
...
CREATE TABLE `seats` (
  ...
  `status` enum('Disponible','Ocupada') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indices de la tabla `film_sessions`
--
...
--
-- AUTO_INCREMENT de la tabla `film_sessions`
--
ALTER TABLE `film_sessions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `film_sessions`
--
ALTER TABLE `film_sessions`
